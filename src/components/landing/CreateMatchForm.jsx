...
// The create-match form, shared by the standalone page and the modal.
// Calls onCreated(matchId) after a successful create.
export default function CreateMatchForm({ onCreated, className = 'match-form', heading }) {
  ...
  return (
    <form onSubmit={handleSubmit} className={className}>
      ...
      <button type="submit" className="btn btn-primary btn-create" disabled={isSubmitting}>
